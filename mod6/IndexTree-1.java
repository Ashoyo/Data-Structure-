...
// This is because we use generics when we have no idea what kind of data we are 
getting
...
// this should print out each word followed by the number of occurrences and 
...
try {
Scanner scanner = new Scanner(new File("C:\\Users\\jimmy\\
OneDrive\\Desktop\\code11\\shakespeare.txt"));
int lineNum = 0;
