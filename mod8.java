...
public class Hangman {
    public static void main(String[] args){
        ...
        while(gameOngoing) {
            ...
            try {
                Scanner scanner = new Scanner(new File("A:\\coding 2022\\
dictionary.txt"));
            ...
            while (true) {
                ...
                for (String word : wordList) {
                    ...
                    if (!wordConfigurations.containsKey(configuration)) 
wordConfigurations.put(configuration, new HashSet<>());
                    ...
                    if (wordConfigurations.get(config).size() > largestSet.size()) 
{
                        ...
                        largestSet = (HashSet<String>) 
wordConfigurations.get(config);
                    }
                }
                wordList = largestSet;
